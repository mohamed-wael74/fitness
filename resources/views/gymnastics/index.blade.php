...
@section('content')
    <main class="py-4">
        <div class="container" data-aos="fade-up">
                    ...
                    <div class="row" id="exercises">
                        <div class="col-lg-3 col-md-4 col-sm-12  d-flex align-items-stretch">
                            <div class="card col-lg-3" style="width: 18rem;">
                                <img src="{{ asset('photos/1684232836.PNG') }}" class="card-img-top" alt="..."
                                    style="height:16rem">
                                <div class="card-body">
                                    <h5 class="card-title text-center">Swiss Ball Crunch</h5>
                                    <p class="text-center"> abs </p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-4 col-sm-12  d-flex align-items-stretch">
                            <div class="card col-lg-3" style="width: 18rem;">
                                <img src="{{ asset('photos/1684227401.PNG') }}" class="card-img-top" alt="..."
                                    style="height:16rem">
                                <div class="card-body">
                                    <h5 class="card-title text-center">Single-Arm Bench Press</h5>
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-12  d-flex align-items-stretch">
                            <div class="card col-lg-3" style="width: 18rem;">
                                <img src="{{ asset('photos/1684229764.PNG') }}" class="card-img-top" alt="..."
                                    style="height:16rem">
                                <div class="card-body">
                                    <h5 class="card-title text-center">Dumbbell Curl</h5>
                                    <p class="text-center"> Biceps </p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-4 col-sm-12  d-flex align-items-stretch">
                            <div class="card col-lg-3" style="width: 18rem;">
                                <img src="{{ asset('photos/1684234621.PNG') }}" class="card-img-top" alt="..."
                                    style="height:16rem">
                                <div class="card-body">
                                    <h5 class="card-title text-center">Leg Press</h5>
                                    <p class="text-center"> Leg </p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <!-- ======= Subscribe ======= -->
            <section id="offers" class="services">
                <div class="container" data-aos="fade-up">
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6 d-flex align-items-stretch">
                            <div class="icon-box">
                                <div class="icon"><i class="bx bxl-dribbble"></i></div>
                                <h4><a href="#offers">Partial subscription</a></h4>
                                <h5> <span style=" color:#ffc107">NOW</span> You can watch more videos about your
                                    exercise and read more about it
                                    <br> 600 LE
                                </h5>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 d-flex align-items-stretch mt-4 mt-md-0" data-aos="zoom-in"
                            ...
                            <div class="icon-box">
                                ...
                                <h4><a href="#offers">Total subscription</a></h4>
                                <h5> <span style=" color:#ffc107 ">NOW</span> You can watch more videos about your
                                    exercise and read more about it
                                    <br> AND TRAIN WITH PERSONAL TRAINER
                                    <br> 1100 LE
                                </h5>
                            </div>
                        </div>
                    ...
                    <div class="payment">
                        <section class="btn-group" style="width:100%">
                            <button class="btn1 details"
                                style="width:33.3%; border-bottom-left-radius: 5px; border-top-left-radius: 5px;">Details
                                <i class='fas fa-angle-right'></i></button>
                            <button class="btn2" style="width:33.3%">Method <i class='fas fa-angle-right'></i></button>
                            <button class="btn3"
                                style="width:33.3%; border-top-right-radius: 5px; border-bottom-right-radius: 5px;">Payment
                            </button>
                        </section>
                        <section class="voting row">
                            <form class="vote-form col-lg-6 col-md-6 col-sm-12" style="display: block;">
                                <h2 class="text-center my-3">Subscription</h2>
                                <h5> <span style=" color:#ffc107">NOW</span> You can watch more videos about your
                                    exercise and read more about it and have a personal trainer if you subscripe total
                                </h5>
                                <div class="Sub-button">
                                    <span class=" my-5 btn btn-primary col-12 " id="continueone">Continue <i
                            ...
                            <form class="vote-form-two" style="display: none;">
                                <div class="photo-container p-5">
                                    <a class="imgone mr-3 btn btn-warning"> MasterCard </a>
                                    <a class="imgtwo mr-3 btn btn-success"> Visa </a>
                                </div>
                            </form>
                            <form class="vote-form-three col-lg-4 col-md-6 col-sm-12" style="display: none;">
                                ...
                                <p>
                                    You will pay 600 LE for partial
                                </p>
                                <p>
                                    You will pay 1100 LE for total
                                </p>
                                <h6><a class="btn btn-warning" href="{{ route('partial.index') }}">PAY Partial</a> <a class="btn btn-warning" href="{{ route('full.index') }}">Pay Total</a></h6>
                                <h6></h6>
                            </form>
                        </section>
                    </div>
                                        ...
                                        <div id="results">
                                            ...
                                            <div class="form-group">
                                                <div class="input-group">
                                                    <input type="number" class="form-control" id="total-calories"
                                                        disabled>
                                                </div>
                                            </div>
                                        </div>
